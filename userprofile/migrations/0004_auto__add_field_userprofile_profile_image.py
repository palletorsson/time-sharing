...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('userprofile_userprofile', 'profile_image',
                      self.gf('django.db.models.fields.files.ImageField')(default='profile.jpg', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Userprofile.profile_image'
        db.delete_column('userprofile_userprofile', 'profile_image')
